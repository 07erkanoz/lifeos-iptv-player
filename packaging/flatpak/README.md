...
3. Replace mutable source reference with immutable tag/commit (do not submit `branch: main`).
...
3. Değişken kaynak yerine sabit tag/commit kullan (`branch: main` ile PR açma).
